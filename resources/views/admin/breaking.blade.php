...
<input   class="check breaking"  type="checkbox" value="{{$post->id}}">
<script type="text/javascript">
  $('.check').prop('checked', true);
</script>
@else
<input  class="breaking"  type="checkbox" value="{{$post->id}}">
@endif
