...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <header class="main-header">
    ...
    <a href="{{url('/back')}}" class="logo">
      ...
      <span class="logo-lg">Control Pannel</span>
    </a>
              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
      <img src="{{url('admin/dist/img/user-alt-128.png') }}" class="img-circle" alt="User Image">
                      </div>
                      <h4>
              ...
              <li class="footer"><a id="Allmssgs">See All Messages</a></li>
            </ul>
          </li>
